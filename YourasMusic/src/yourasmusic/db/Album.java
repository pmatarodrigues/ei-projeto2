...
public class Album implements Serializable {
    ...
    @JoinColumn(name = "EDITORA_ID", referencedColumnName = "UTILIZADOR_ID")
    @ManyToOne(optional = false)
    private Utilizador editoraId;
    ...
    public Utilizador getEditoraId() {
        return editoraId;
    }

    public void setEditoraId(Utilizador editoraId) {
    ...
    public String toString() {
        return "yourasmusic.db.Album[ albumId=" + albumId + " ]";
    }
